...
do {
  ...
  <div class="list-group list-group-flush">
    <a href='?idmapa=<?=$idmapa;?>&idvtr=<?=$idvtr;?>' class="list-group-item list-group-item-action <?php if(($idvtr == $_GET['idvtr']) OR ($tipo == $_GET['vtrtipo']))  echo 'active';?>" aria-current="true">
      <div class="d-flex justify-content-between">
        <img src='../veiculos/vtrimg/<?=$img;?>' width="80" >
        <h6><?=$tipo;?></h6>
      </div>
    </a>
  </div>
      ...
      <a class="navbar-brand" href="?idmapa=<?=$idmapa;?>">
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="?idmapa=<?=$idmapa;?>&acao=ins"><i class="fas fa-plus-circle"></i> Adicionar</a>
            </li>
          </ul>
        </div>
      </div>
